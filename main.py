...
def clear_data():
    ...
    for session in sessions_list[1:]:
        ...
        for line in session_cleared:
            ...
            formatted_list = get_exercise_dict(line_cleared[0], line_cleared[1], line_cleared[2])
...
def get_exercise_dict(exercise_name: str, numerical_values: str, muscles_worked: str) -> list:
    """
